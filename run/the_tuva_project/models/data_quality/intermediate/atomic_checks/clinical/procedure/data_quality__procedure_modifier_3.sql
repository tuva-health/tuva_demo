        ...
        create or replace transient table tuva_synthetic.data_quality.procedure_modifier_3
         as
        (
...
left join tuva_synthetic.terminology.hcpcs_level_2 term on m.modifier_3 = term.hcpcs
        );
