        ...
        create or replace transient table tuva_synthetic.data_quality.procedure_modifier_2
         as
        (
...
left join tuva_synthetic.terminology.hcpcs_level_2 term on m.modifier_2 = term.hcpcs
        );
