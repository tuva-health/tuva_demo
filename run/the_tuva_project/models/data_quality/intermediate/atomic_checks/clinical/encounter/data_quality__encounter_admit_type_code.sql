        ...
        create or replace transient table tuva_synthetic.data_quality.encounter_admit_type_code
         as
        (
...
left join tuva_synthetic.terminology.admit_type term on m.admit_type_code = term.admit_type_code
        );
