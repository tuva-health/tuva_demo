        ...
        create or replace transient table tuva_synthetic.data_quality.encounter_encounter_start_date
         as
        (
...
SELECT
    ...
    , case
        when m.encounter_start_date > cast(substring('2024-10-04 19:08:24.316902+00:00',1,10) as date) then 'invalid'
    ...
    , case
        when m.encounter_start_date > cast(substring('2024-10-04 19:08:24.316902+00:00',1,10) as date) then 'future'
