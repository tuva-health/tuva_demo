        ...
        create or replace transient table tuva_synthetic.data_quality.condition_onset_date
         as
        (
...
SELECT
    ...
    ,case
        when m.onset_date > cast(substring('2024-10-04 19:08:24.316902+00:00',1,10) as date) then 'invalid'
    ...
    ,case
        when m.onset_date > cast(substring('2024-10-04 19:08:24.316902+00:00',1,10) as date) then 'future'
