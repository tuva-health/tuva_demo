        ...
        create or replace transient table tuva_synthetic.core.medication
         as
        (
...
with source_mapping as (
   ...
   , meds.data_source
   , meds.tuva_last_run
from tuva_synthetic.core._stg_clinical_medication meds
    left join tuva_synthetic.terminology.ndc ndc
        on meds.source_code_type = 'ndc'
        and meds.source_code = ndc.ndc
    left join tuva_synthetic.terminology.rxnorm_to_atc rxatc
