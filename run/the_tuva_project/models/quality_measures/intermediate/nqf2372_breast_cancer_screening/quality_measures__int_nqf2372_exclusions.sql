        ...
        create or replace transient table tuva_synthetic.quality_measures._int_nqf2372_exclusions
         as
        (with frailty as (
...
, valid_mastectomy_patients as (
    ...
    select
      ...
      , exclusion_date
      , exclusion_reason
    from tuva_synthetic.quality_measures._int_nqf2372_exclude_mastectomy
)
...
, combined_exclusions as (
    ...
    , denominator.age
    from exclusions
    inner join tuva_synthetic.quality_measures._int_nqf2372_denominator denominator
