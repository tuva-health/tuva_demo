        ...
        create or replace transient table tuva_synthetic.quality_measures._int_nqf0059_exclusions
         as
        (with frailty as (
  ...
  from tuva_synthetic.quality_measures._int_nqf0059__performance_period
...
, combined_exclusions as (
  ...
  select 
    ...
    , denominator.age
  from exclusions
  inner join tuva_synthetic.quality_measures._int_nqf0059_denominator as denominator
