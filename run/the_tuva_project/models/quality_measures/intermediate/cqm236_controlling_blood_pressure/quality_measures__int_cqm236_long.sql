        ...
        create or replace transient table tuva_synthetic.quality_measures._int_cqm236_long
         as
        (
...
, numerator as (
    ...
    select
          patient_id
        , observation_date
    from tuva_synthetic.quality_measures._int_cqm236_numerator
...
, exclusions as (
    ...
    select
        ...
        , exclusion_date
        , exclusion_reason
    from tuva_synthetic.quality_measures._int_cqm236_exclusions
