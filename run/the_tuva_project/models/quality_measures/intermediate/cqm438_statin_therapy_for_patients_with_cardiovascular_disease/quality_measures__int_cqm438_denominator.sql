        ...
        create or replace transient table tuva_synthetic.quality_measures._int_cqm438_denominator
         as
        (
...
from tuva_synthetic.core.patient
    ...
    select 
        ...
        , measure_version
        , 1 as criteria
    from tuva_synthetic.quality_measures._int_cqm438_denominator_criteria1
...
, patients_with_cholesterol as (
    ...
    select 
        ...
        , measure_version
        , 2 as criteria
    from tuva_synthetic.quality_measures._int_cqm438_denominator_criteria2
...
, patients_with_diabetes as (
    ...
    select 
        ...
        , measure_version
        , 3 as criteria
    from tuva_synthetic.quality_measures._int_cqm438_denominator_criteria3
...
, visits_encounters as (
    ...
    inner join tuva_synthetic.quality_measures._int_cqm438__performance_period as pp
...
, claims_encounters as (
    ...
    inner join tuva_synthetic.quality_measures._int_cqm438__performance_period  as pp on
...
, patients_with_age as (
    ...
    cross join tuva_synthetic.quality_measures._int_cqm438__performance_period
