        ...
        create or replace transient table tuva_synthetic.quality_measures._int_cqm48_exclusions
         as
  ...
  from tuva_synthetic.quality_measures._int_cqm48__performance_period
) and (
  select 
...
, combined_exclusions as (
  ...
  inner join tuva_synthetic.quality_measures._int_cqm48_denominator as denominator
