        ...
        create or replace transient table tuva_synthetic.quality_measures._int_cqm48_long
         as
        (
...
, numerator as (
    ...
    select
        ...
        , evidence_date
        , evidence_value
    from tuva_synthetic.quality_measures._int_cqm48_numerator
...
, exclusions as (
    ...
    select
        ...
        , exclusion_date
        , exclusion_reason
    from tuva_synthetic.quality_measures._int_cqm48_exclusions
