...
with tuva_last_run as(
    select
       cast('2024-10-04 19:11:18.274664+00:00' as TIMESTAMP ) as tuva_last_run_datetime
       , cast(substring('2024-10-04 19:11:18.274664+00:00',1,10) as date ) as tuva_last_run_date
)
SELECT
