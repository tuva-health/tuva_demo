...
SELECT
    ...
    , case
        when m.collection_date > cast(substring('2024-10-04 19:11:18.274664+00:00',1,10) as date) then 'invalid'
    ...
    , case
        when m.collection_date > cast(substring('2024-10-04 19:11:18.274664+00:00',1,10) as date) then 'future'
