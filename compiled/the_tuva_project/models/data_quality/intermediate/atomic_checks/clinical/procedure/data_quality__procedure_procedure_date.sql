...
SELECT
    ...
    , case
        when m.procedure_date > cast(substring('2024-10-04 19:11:18.274664+00:00',1,10) as date) then 'invalid'
        when m.procedure_date <= cast('1901-01-01' as date) then 'invalid'
        when m.procedure_date is null then 'null'
        else 'valid'
    end as bucket_name
    , case
        when m.procedure_date > cast(substring('2024-10-04 19:11:18.274664+00:00',1,10) as date) then 'future'
